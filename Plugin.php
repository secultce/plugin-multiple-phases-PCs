...
class Plugin extends \MapasCulturais\Plugin
{
    public function _init()
    {
        ...
        //HOOK para ficar escutando a mudança de valores do select
     ...
     * @return void
     */
    protected static function upLastPhase($app, $countIsPhases, $count_total_pc, $parent, $valueUpdate)
    {
        $parentId = null;
